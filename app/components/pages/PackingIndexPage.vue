...
<template>
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          ...
          <MpTooltip id="tt-pack-export" :label="t('Export')" placement="bottom" use-portal>
            <MpButton variant="ghost" class="filter-icon-btn" :aria-label="t('Export')"><MpIcon name="download" size="md" /></MpButton>
          </MpTooltip>
        </div>
    ...
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          <MpButton variant="ghost" class="btn-enterprise btn-enterprise--ghost" @click="closeCancelModal">{{ t('Keep task') }}</MpButton>
  ...
  <MpPopover id="pack-demo-fab" is-close-on-select use-portal placement="top-end">
    <MpPopoverTrigger>
      <MpButton variant="secondary" class="demo-fab" :aria-label="t('Change scenario state')"><MpIcon name="sliders" size="md" color="icon.inverse" /></MpButton>
    </MpPopoverTrigger>
