  ...
  >
    ...
    <template #filters>
      <div class="filter-left">
        <MpPopover v-if="!isScoped" id="shp-wh-filter" :is-close-on-select="false">
          <MpPopoverTrigger>
            <MpSelect
              id="shp-wh-select" placeholder="Warehouse"
        ...
        <MpPopover id="shp-status-filter" :is-close-on-select="false">
          <MpPopoverTrigger>
            <MpSelect
              id="shp-status-select" placeholder="Status" :model-value="statusFilter.length ? 'set' : ''" is-clearable
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          <MpTooltip id="tt-shp-airene" label="Ask Airene" placement="bottom" use-portal>
          ...
          <MpTooltip id="tt-shp-export" label="Export" placement="bottom" use-portal>
    ...
    <template #empty>
      <div class="empty-full">
        ...
        <p class="empty-full-title">No shipments</p>
        <p class="empty-full-desc">Deliveries handed over to a courier will appear here.</p>
      </div>
    </template>
  </ErpTablePage>
