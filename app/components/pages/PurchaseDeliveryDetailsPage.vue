...
function confirmDelete() {
  toast.notify({ variant: 'success', title: t('Purchase delivery deleted'), rootProps: { class: 'toast-enterprise' } })
  router.push('/purchase-deliveries')
}
const activityEntries = computed(() => [{
  ...
  activity: t('Created'),
  details: [
    { label: t('Transaction no.'), value: `${t('Purchase Delivery')} #${delivery.value.number}` },
    { label: t('Transaction date'), value: formatDateLong(delivery.value.date) },
    { label: t('Vendor'), value: delivery.value.vendor.name },
...
const jumpResults = computed(() => {
  const recent = [...purchaseDeliveries].sort((a, b) => b.date.localeCompare(a.date))   // most recent first
  const q = jumpSearch.value.trim().toLowerCase()
  const matched = q
    ? recent.filter(o => String(o.number).includes(q) || o.vendor.name.toLowerCase().includes(q))
    : recent
  return matched.slice(0, 5)   // 5 most recent (or top 5 matches)
})
function jumpTo(id: string) { router.push('/purchase-deliveries/' + id) }
...
function goBack() { router.push('/purchase-deliveries') }
</script>
  ...
  <div class="detail-page">
    ...
    <header class="detail-bar">
      <div class="detail-bar-left">
        <MpTextlink id="detail-breadcrumb" as="a" class="detail-breadcrumb" @click.prevent="goBack">{{ t('Purchase deliveries') }}</MpTextlink>
        <div class="detail-titlerow-left">
          <h1 class="detail-title">{{ t('Purchase Delivery') }} #{{ delivery.number }}</h1>
              ...
              <div class="detail-jump">
                ...
                <div class="detail-jump-list">
                  <button
                    ...
                    @click="jumpTo(o.id)"
                  >
                    <span class="detail-jump-item-number">{{ t('Purchase Delivery') }} #{{ o.number }}</span>
      ...
      <section class="detail-summary">
        ...
        <div class="content-list-grid">
          <div class="content-list-col">
            <ContentList :label="t('Vendor')" :value="delivery.vendor.name" />
          </div>
          <div class="content-list-col">
        ...
        <div class="content-list-grid">
          ...
          <!-- col 4: references -->
          <div class="content-list-col">
            <ContentList :label="t('Transaction no.')" :value="`${t('Purchase Delivery')} #${delivery.number}`" />
    ...
    <ActivityLogModal
      ...
      :subject="`${t('Purchase Delivery')} #${delivery.number}`"
    ...
    <ConfirmModal
      ...
      :title="t('Delete purchase delivery?')"
