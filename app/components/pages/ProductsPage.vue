  ...
  >
    ...
    <template #filters>
      <div class="filter-left">
        ...
        <MpButton variant="secondary" class="filter-all-btn" left-icon="filter">
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          ...
          <MpTooltip id="prod-tt-airene" label="Ask Airene" placement="bottom" use-portal>
            <MpButton variant="secondary" class="filter-icon-btn filter-icon-btn--airene" aria-label="Ask Airene" @click="toggleAirene?.()">
        ...
        <div class="filter-search">
          ...
          <input
            ...
            placeholder="Search..."
          />
          <MpButton v-if="search" variant="secondary" class="search-clear-btn" aria-label="Clear search" @click="search = ''">
    ...
    <template #actions="{ row }">
      <MpPopover :id="`prod-actions-${(row as ProductIndexRow).id}`" is-close-on-select use-portal :is-keep-alive="false" placement="bottom-end">
        <MpPopoverTrigger>
          <MpButton variant="secondary" class="row-kebab" aria-label="More actions">
    ...
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          <MpButton variant="ghost" class="btn-enterprise btn-enterprise--ghost" @click="closeExportModal">Cancel</MpButton>
          <MpButton variant="primary" class="btn-enterprise btn-enterprise--primary" @click="closeExportModal">Export</MpButton>
        </div>
      </MpModalFooter>
    </MpModalContent>
    <MpModalOverlay />
