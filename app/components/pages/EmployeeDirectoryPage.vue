...
<template>
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          <MpTooltip id="emp-tt-airene" label="Ask Airene" placement="bottom" use-portal>
            <MpButton class="filter-icon-btn filter-icon-btn--airene" type="button" aria-label="Ask Airene" @click="toggleAirene?.()">
          ...
          <MpTooltip id="emp-tt-export" label="Export" placement="bottom" use-portal>
            <MpButton class="filter-icon-btn" type="button" aria-label="Export" left-icon="download" @click="exportCsv" />
          </MpTooltip>
        </div>
    ...
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          <MpButton class="btn-enterprise btn-enterprise--ghost" @click="resignModalOpen = false">Cancel</MpButton>
          <MpButton class="btn-enterprise btn-enterprise--primary" @click="confirmResign">Resign</MpButton>
        </div>
      </MpModalFooter>
    </MpModalContent>
    <MpModalOverlay />
  ...
  <MpModal :is-close-on-esc="false" :is-close-on-overlay-click="false" id="emp-delete-modal" :is-open="deleteModalOpen" size="md" :is-keep-alive="false" @close="deleteModalOpen = false">
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          <MpButton class="btn-enterprise btn-enterprise--ghost" @click="deleteModalOpen = false">Cancel</MpButton>
