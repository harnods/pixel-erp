...
const columns: TableColumn[] = [
  { key: 'name',             label: 'Employee name',     width: '260px', sortable: true, sortType: 'text' },
  { key: 'employeeId',       label: 'Employee ID',       width: '140px', sortType: 'text' },
  { key: 'nik',              label: 'Citizen ID',        width: '180px', sortType: 'text' },
  { key: 'branch',           label: 'Branch',            width: '190px', sortType: 'text' },
  { key: 'department',       label: 'Organization',      width: '160px', sortType: 'text' },
  { key: 'jobPosition',      label: 'Job position',      width: '220px', sortType: 'text' },
  { key: 'jobLevel',         label: 'Job level',         width: '140px', sortType: 'text' },
  { key: 'employmentStatus', label: 'Employment status', width: '170px', sortType: 'text' },
  { key: 'status',           label: 'Status',            width: '120px', sortType: 'text' },
  { key: 'joinDate',         label: 'Date of joining',   width: '160px', sortType: 'date' },
  { key: 'signDate',         label: 'Signing date',      width: '150px', sortType: 'date' },
  { key: 'contractEndDate',  label: 'End date',          width: '150px', sortType: 'date' },
  { key: 'resignDate',       label: 'Resignation date',  width: '170px', sortType: 'date' },
  { key: 'barcode',          label: 'Barcode',           width: '140px', sortType: 'text' },
  { key: 'email',            label: 'Email',             width: '300px', sortType: 'text' },
  { key: 'phone',            label: 'Phone no.',         width: '170px' },
  { key: 'address',          label: 'Address',           width: '260px' },
  { key: 'dateOfBirth',      label: 'Birth date',        width: '150px', sortType: 'date' },
  { key: 'placeOfBirth',     label: 'Birth place',       width: '150px', sortType: 'text' },
  { key: 'religion',         label: 'Religion',          width: '140px', sortType: 'text' },
  { key: 'gender',           label: 'Gender',            width: '120px', sortType: 'text' },
  { key: 'maritalStatus',    label: 'Marital status',    width: '150px', sortType: 'text' },
]
