...
const jumpResults = computed(() => {
  const all = receiptsForStage('Partial reception')
...
function openCloseModal() { closeModalOpen.value = true }
function dismissCloseModal() { closeModalOpen.value = false }
...
<template>
  <div v-if="detail" class="detail-page">
    ...
    <div ref="stageEl" class="detail-stage">
      ...
      <!-- ── Line items table — with received qty + put-away qty columns ── -->
...
.btn-enterprise--secondary { background: var(--mp-background-neutral); border-color: var(--mp-border-bold); color: var(--mp-text-secondary); }
.btn-enterprise--secondary:hover { background: var(--mp-background-neutral-hovered); }
.btn-enterprise--danger { background: var(--mp-colors-red-600, #dc2626); border-color: var(--mp-colors-red-600, #dc2626); color: #fff; }
.btn-enterprise--danger:hover { background: var(--mp-colors-red-700, #b91c1c); border-color: var(--mp-colors-red-700, #b91c1c); }
</style>
