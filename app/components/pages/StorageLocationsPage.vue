      ...
      <MpModalContent>
        ...
        <MpModalFooter>
          <div class="sl-modal-btns">
            <MpButton variant="ghost" class="btn-enterprise btn-enterprise--ghost" @click="editOpen = false">{{ t('Cancel') }}</MpButton>
            <MpButton variant="primary" class="btn-enterprise btn-enterprise--primary" :is-disabled="isSaving" @click="saveEdit">{{ isSaving ? t('Saving…') : t('Save changes') }}</MpButton>
          </div>
        </MpModalFooter>
      </MpModalContent>
      <MpModalOverlay />
