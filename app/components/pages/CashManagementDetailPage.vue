      ...
      <section class="cmd-overview">
        <div class="cmd-ov-item cmd-account">
          ...
          <div class="cmd-account-col">
            ...
            <button v-if="account.isConnected" type="button" class="cmd-last-updated btn-enterprise" @click="refreshConnection">
                ...
                <div class="cmd-stmt-filterbar">
                  ...
                  <div class="cmd-stmt-filterrow">
                    <div class="cmd-stmt-filterrow-left">
                      <button type="button" class="cmd-daterange-pill btn-enterprise">
                    ...
                    <div class="cmd-stmt-filterrow-right">
                      <button class="filter-icon-btn filter-icon-btn--airene btn-enterprise" :aria-label="t('Ask Airene')">
                ...
                <div class="cmd-stmt-filterbar">
                  ...
                  <div class="cmd-stmt-filterrow">
                    ...
                    <div class="cmd-stmt-filterrow-right">
                      ...
                      <button class="filter-icon-btn btn-enterprise" :aria-label="t('Export')">
