...
import {
  ...
  MpModalOverlay, MpModalCloseButton, MpInput, css, toast, MpButton,
} from '@mekari/pixel3'
...
<template>
  ...
  >
    ...
    <template #bulk-actions="{ deselectAll, selectedRows }">
      ...
      <MpPopover id="rcv-bulk-actions" is-close-on-select placement="bottom-start" use-portal>
        <MpPopoverTrigger>
          <MpButton class="btn-enterprise btn-enterprise--secondary btn-enterprise--sm btn-enterprise--icon-after" variant="secondary">
            {{ t('Actions') }}
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          ...
          <MpTooltip id="tt-rcv-export" :label="t('Export')" placement="bottom" use-portal>
            <MpButton class="filter-icon-btn" variant="secondary" :aria-label="t('Export')">
    ...
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          ...
          <MpButton class="btn-enterprise btn-enterprise--danger" variant="danger" @click="confirmCancel">{{ t('Cancel receipt') }}</MpButton>
        </div>
      </MpModalFooter>
    </MpModalContent>
    <MpModalOverlay />
    ...
    <MpModalContent>
      ...
      <MpModalFooter>
        <div class="modal-footer-btns">
          ...
          <MpButton class="btn-enterprise btn-enterprise--primary" variant="primary" @click="confirmClose">{{ t('Close receipt') }}</MpButton>
        </div>
      </MpModalFooter>
    </MpModalContent>
    <MpModalOverlay />
  ...
  >
    <MpModalContent>
          ...
          <div class="track-modal__list">
            <div v-for="(no, i) in g.nos" :key="i" class="track-modal__row">
              <MpInput
                ...
                is-full-width
              />
              <MpButton class="track-modal__remove" variant="secondary" :aria-label="t('Remove tracking no.')" @click="removeTracking(gi, i)">
                <MpIcon name="minus-circular" size="sm" />
              </MpButton>
            </div>
          </div>
          <MpButton class="track-modal__add" variant="secondary" left-icon="add" @click="addTracking(gi)">
            {{ t('Add tracking no.') }}
          </MpButton>
        </div>
      </MpModalBody>
      <MpModalFooter>
        <div class="modal-footer-btns">
          <MpButton class="btn-enterprise btn-enterprise--ghost" variant="ghost" @click="closeTrackingModal">{{ t('Cancel') }}</MpButton>
          <MpButton class="btn-enterprise btn-enterprise--primary" variant="primary" :is-disabled="isSaving" @click="saveTracking">{{ isSaving ? t('Saving…') : t('Save changes') }}</MpButton>
        </div>
      </MpModalFooter>
    </MpModalContent>
    <MpModalOverlay />
  ...
  <MpPopover id="rcv-demo-fab" is-close-on-select use-portal placement="top-end">
    <MpPopoverTrigger>
      <MpButton class="demo-fab" variant="secondary" :aria-label="t('Change scenario state')">
