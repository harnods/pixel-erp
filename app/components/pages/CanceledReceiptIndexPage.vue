...
const columns: TableColumn[] = [
  { key: 'purchaseNo',     label: 'Purchase no.',   width: '240px', sortType: 'text' },
  { key: 'warehouseName',  label: 'Warehouse',      width: '170px', sortType: 'text' },
  { key: 'skuQty',         label: 'SKU qty',        width: '90px',  align: 'right', sortType: 'number' },
  { key: 'purchaseQty',    label: 'Purchase qty',   width: '110px', align: 'right', sortType: 'number' },
  { key: 'canceledReason', label: 'Reason',         width: '200px', sortType: 'text' },
  { key: 'canceledDate',   label: 'Canceled date',  width: '150px', sortType: 'date' },
]
