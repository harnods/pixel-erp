...
const columns: TableColumn[] = [
  { key: 'purchaseNo',     label: 'Purchase no.',   width: '240px' },
  { key: 'warehouseName',  label: 'Warehouse',      width: '170px' },
  { key: 'skuQty',         label: 'SKU qty',        width: '90px',  align: 'right' },
  { key: 'purchaseQty',    label: 'Purchase qty',   width: '110px', align: 'right' },
  { key: 'canceledReason', label: 'Reason',         width: '200px' },
  { key: 'canceledDate',   label: 'Canceled date',  width: '150px' },
]
