...
<template>
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          ...
          <MpTooltip id="tt-cxl-export" :label="t('Export')" placement="bottom" use-portal>
            <MpButton class="filter-icon-btn" variant="ghost" left-icon="download" :aria-label="t('Export')" />
          </MpTooltip>
        </div>
  ...
  <MpPopover id="cxl-demo-fab" is-close-on-select use-portal placement="top-end">
    <MpPopoverTrigger>
      <MpButton class="demo-fab" left-icon="sliders" :aria-label="t('Change scenario state')" />
    </MpPopoverTrigger>
