 ...
 *
 * Built entirely from Pixel 3 Enterprise (DT 2.4) components — MpButton, MpTabs,
 * MpBadge, MpTextarea, MpSelect, MpProgress, MpToggle, MpModal, MpIcon — plus the
 * established ERP enterprise-card + table conventions. Nothing bespoke.
 *
...
// MpTabs v-model is a numeric index (panels match by order): 0 Overview, 1 Tasks,
// 2 Schedule, 3 Connections.
...
<template>
  <div class="cowork">
    ...
    <!-- ══ INDEX ══ -->
    <MpTabs v-else id="cowork-tabs" v-model="activeTab" is-manual variant-color="green">
      <MpTabList>
        <MpTab id="cw-tab-overview" value="overview">Overview</MpTab>
        <MpTab id="cw-tab-tasks" value="tasks">Tasks</MpTab>
        <MpTab id="cw-tab-schedule" value="schedule">Schedule</MpTab>
        <MpTab id="cw-tab-connections" value="connections">Connections</MpTab>
      </MpTabList>
      <MpTabPanels>
        <!-- ── Overview ── -->
        <MpTabPanel value="overview">
          ...
          <div class="cw-section-head">
            ...
            <MpButton is-rounded variant="tertiary" size="sm" @click="activeTab = 1">View all</MpButton>
          </div>
          <div class="cw-list">
...
/* Composer */
.cw-composer { margin-top: var(--mp-spacing-5); }
