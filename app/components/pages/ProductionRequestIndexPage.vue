      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          ...
          <span class="pr-tt" :data-tooltip="t('Export')">
            <button class="filter-icon-btn" :aria-label="t('Export')" @click="notifySoon('Export')">
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="pr-tt pr-tt--top" :data-tooltip="t('View attachment')">
                        <button class="pr-source-attach" :aria-label="t('View attachment')" @click.stop="openAttachment">
