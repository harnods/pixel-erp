  ...
  >
    ...
    <template #filters>
      <div class="filter-left">
        <MpPopover v-if="!isScoped" id="cmp-wh-filter" is-close-on-select>
          <MpPopoverTrigger>
            <MpSelect
              id="cmp-wh-select" placeholder="Warehouse" :model-value="warehouseFilter" is-clearable
      ...
      <div class="filter-right">
        <div class="filter-btn-group">
          <MpTooltip id="tt-cmp-airene" label="Ask Airene" placement="bottom" use-portal>
          ...
          <MpTooltip id="tt-cmp-export" label="Export" placement="bottom" use-portal>
    ...
    <template #empty>
      <div class="empty-full">
        ...
        <p class="empty-full-title">No completed receipts</p>
        <p class="empty-full-desc">Fully received purchase orders will appear here.</p>
      </div>
    </template>
  </ErpTablePage>
