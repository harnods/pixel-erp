...
const transactionTypeOptions = taskDocTypeTabs
  .filter((t) => t.docType)
  ...
  >
    ...
    <template #filters>
      <div class="filter-left">
        ...
        <!-- Transaction type — typeable: typing filters the popover list.
             is-searchable is required or the input renders read-only (typing
             wouldn't actually work for a real user) — it also happens to be
             required for the built-in clear (x) icon to render at all, giving
             the same reset affordance as the Expense index's status filter. -->
        <MpAutocomplete
