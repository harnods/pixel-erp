      ...
      <div class="mbd-content">
        ...
        <div class="mbd-info-bar">
          ...
          <div class="mbd-info-stats">
            <div class="mbd-stat">
              <span class="mbd-stat-label">On hand</span>
            ...
            <div
              class="mbd-stat"
              :class="{
                'mbd-stat--pos': (totalDifference ?? 0) > 0,
                'mbd-stat--neg': (totalDifference ?? 0) < 0,
              }"
            >
        ...
        <div class="mbd-filter-bar">
          <MpPopover id="mbd-progress" is-close-on-select use-portal>
            <MpPopoverTrigger>
          ...
          <table class="mbd-table">
            ...
            <thead>
              <tr>
                ...
                <th class="mbd-th mbd-th--num">Counted qty</th>
                <th class="mbd-th mbd-th--num">Difference</th>
...
.mbd-col-num     { width: 116px; }
.mbd-col-counted { width: 116px; }
