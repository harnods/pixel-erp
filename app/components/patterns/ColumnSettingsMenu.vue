 ...
 */
import { MpPopover, MpPopoverTrigger, MpPopoverContent, MpCheckbox, MpTooltip, css } from '@mekari/pixel3'
...
<template>
  <MpPopover :id="id" placement="bottom-end" use-portal :is-keep-alive="false">
    <MpPopoverTrigger>
      <MpTooltip :id="`${id}-tooltip`" label="Column settings" placement="bottom" use-portal>
        <button class="cs-trigger" aria-label="Column settings" type="button">
