        ...
        <div class="pr-sku-section">
          ...
          <div class="pr-filter-bar">
            ...
            <div class="pr-filter-search">
              ...
              <MpButton v-if="search" class="search-clear-btn" variant="ghost" size="sm" left-icon="close" aria-label="Clear search" @click="search = ''" />
            </div>
          </div>
...
.search-clear-btn { flex-shrink: 0; color: var(--mp-icon-default, var(--mp-text-secondary)); }
