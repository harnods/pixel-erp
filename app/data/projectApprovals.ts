...
export interface ApprovalItem {
  ...
  payload?: { lines: { wpId: string; account: string; amount: number }[]; reserves: Record<string, number>; revenue: number; baseRevisionNo?: number }
}
...
const SEED: ApprovalItem[] = [
  ...
  { id: 'ap-5', kind: 'budget_revision', projectId: 'ps-2606', refId: 'brq-1', refNo: 'BR-2606-01', title: 'Pindahkan Rp6.000.000 dari cadangan Produksi ke 2.1 Subkontraktor', requestedBy: 'Andi Pratama', requestedAt: '2026-06-24', amount: 6_000_000, reason: 'Tower B requires extra installers for the 18th-floor units (no service lift).', status: 'pending' },
